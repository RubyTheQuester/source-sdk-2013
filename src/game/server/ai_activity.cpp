...
//===========================
	...
	// MERC SHOTGUN //
	//==============//
	ADD_ACTIVITY_TO_SR( ACT_MERC_STAND_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCH_SHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MERC_WALK_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RUN_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCHWALK_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_SWIM_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_AIRWALK_SHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_STAND_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_CROUCH_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_SWIM_SHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_AIRWALK_SHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_SHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_SHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_SHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_AIRWALK_SHOTGUN_LOOP );

	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_SHOTGUN_END );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_SHOTGUN_END );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_SHOTGUN_END );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_AIRWALK_SHOTGUN_END );


	ADD_ACTIVITY_TO_SR( ACT_MERC_JUMP_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_JUMP_START_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_JUMP_FLOAT_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_JUMP_LAND_SHOTGUN );

	//=====================//
	// MERC ROCKETLAUNCHER //
	//=====================//
	ADD_ACTIVITY_TO_SR( ACT_MERC_STAND_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCH_ROCKETLAUNCHER );

	ADD_ACTIVITY_TO_SR( ACT_MERC_WALK_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RUN_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCHWALK_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_SWIM_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_AIRWALK_ROCKETLAUNCHER );

	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_STAND_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_CROUCH_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_SWIM_ROCKETLAUNCHER );

	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_AIRWALK_ROCKETLAUNCHER );

	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_ROCKETLAUNCHER_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_ROCKETLAUNCHER_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_ROCKETLAUNCHER_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_AIRWALK_ROCKETLAUNCHER_LOOP );

	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_ROCKETLAUNCHER_END );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_ROCKETLAUNCHER_END );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_ROCKETLAUNCHER_END );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_AIRWALK_ROCKETLAUNCHER_END );


	ADD_ACTIVITY_TO_SR( ACT_MERC_JUMP_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_JUMP_START_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_JUMP_FLOAT_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MERC_JUMP_LAND_ROCKETLAUNCHER );

	//=================//
	// MERC CHINA_LAKE //
	//=================//
	ADD_ACTIVITY_TO_SR( ACT_MERC_STAND_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCH_CHINA_LAKE );

	ADD_ACTIVITY_TO_SR( ACT_MERC_WALK_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RUN_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCHWALK_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_SWIM_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_AIRWALK_CHINA_LAKE );

	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_STAND_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_CROUCH_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_SWIM_CHINA_LAKE );

	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_AIRWALK_CHINA_LAKE );

	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_CHINA_LAKE_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_CHINA_LAKE_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_CHINA_LAKE_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_AIRWALK_CHINA_LAKE_LOOP );

	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_CHINA_LAKE_END );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_CHINA_LAKE_END );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_CHINA_LAKE_END );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_AIRWALK_CHINA_LAKE_END );

	ADD_ACTIVITY_TO_SR( ACT_MERC_JUMP_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_JUMP_START_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_JUMP_FLOAT_CHINA_LAKE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_JUMP_LAND_CHINA_LAKE );

	//====================//
	// MERC ASSAULT_RIFLE //
	//====================//
	ADD_ACTIVITY_TO_SR(ACT_MERC_STAND_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCH_ASSAULT_RIFLE);

	ADD_ACTIVITY_TO_SR(ACT_MERC_WALK_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RUN_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCHWALK_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_SWIM_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_AIRWALK_ASSAULT_RIFLE);

	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_STAND_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_CROUCH_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_SWIM_ASSAULT_RIFLE);

	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_STAND_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_CROUCH_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_SWIM_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_AIRWALK_ASSAULT_RIFLE);

	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_START_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_FLOAT_ASSAULT_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_LAND_ASSAULT_RIFLE);
	...
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_STAND_KNIFE_BACKSTAB);

	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_KNIFE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_START_KNIFE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_FLOAT_KNIFE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_LAND_KNIFE);
	...
	//=========================//
	ADD_ACTIVITY_TO_SR(ACT_MERC_STAND_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCH_TOMMYGUN_MERCENARY);

	ADD_ACTIVITY_TO_SR(ACT_MERC_WALK_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RUN_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCHWALK_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_SWIM_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_AIRWALK_TOMMYGUN_MERCENARY);

	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_STAND_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_CROUCH_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_SWIM_TOMMYGUN_MERCENARY);

	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_STAND_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_CROUCH_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_SWIM_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_AIRWALK_TOMMYGUN_MERCENARY);

	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_START_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_FLOAT_TOMMYGUN_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_LAND_TOMMYGUN_MERCENARY);
