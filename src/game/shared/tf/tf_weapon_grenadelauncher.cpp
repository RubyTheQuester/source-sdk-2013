...
acttable_t CTFGrenadeLauncher_Merc::m_acttableChinaLakeMerc[] =
{
...
acttable_t * CTFGrenadeLauncher_Merc::ActivityList( int &iActivityCount )
{
	if ( (GetTFPlayerOwner() != NULL) && GetTFPlayerOwner()->GetPlayerClass()->GetClassIndex() == TF_CLASS_MERCENARY )
	{
		...
		return m_acttableChinaLakeMerc;
	}
	else
	{
