...
static acttable_t m_acttableShotgunSuper[] =
{
	...
	{ ACT_MP_RELOAD_AIRWALK, ACT_MERC_RELOAD_AIRWALK_SUPERSHOTGUN, false },
};
...
static acttable_t m_acttableShotgunMerc[] =
{
	...
	{ ACT_MP_RELOAD_AIRWALK, ACT_MERC_RELOAD_SWIM_SHOTGUN, false },
	...
	{ ACT_MP_RELOAD_AIRWALK_LOOP, ACT_MERC_RELOAD_SWIM_SHOTGUN_LOOP, false },
	...
	{ ACT_MP_RELOAD_AIRWALK_END, ACT_MERC_RELOAD_AIRWALK_SHOTGUN_END, false },
};

static acttable_t m_acttableRevolverMerc[] =
{
...
static acttable_t m_acttableChinaLakeMerc[] =
{
	...
	{ ACT_MP_RELOAD_AIRWALK, ACT_MERC_RELOAD_SWIM_CHINA_LAKE, false },
	...
	{ ACT_MP_RELOAD_AIRWALK_LOOP, ACT_MERC_RELOAD_SWIM_CHINA_LAKE_LOOP, false },
	...
	{ ACT_MP_RELOAD_AIRWALK_END, ACT_MERC_RELOAD_AIRWALK_CHINA_LAKE_END, false },
};
...
static acttable_t m_acttableRifleMerc[] =
{
...
static acttable_t m_acttableKnifeMerc[] =
{
	{ ACT_MP_STAND_IDLE, ACT_MERC_STAND_KNIFE, false },
	{ ACT_MP_CROUCH_IDLE, ACT_MERC_CROUCH_KNIFE, false },
	{ ACT_MP_RUN, ACT_MERC_RUN_KNIFE, false },
	{ ACT_MP_WALK, ACT_MERC_WALK_KNIFE, false },
	{ ACT_MP_AIRWALK, ACT_MERC_AIRWALK_KNIFE, false },
	{ ACT_MP_CROUCHWALK, ACT_MERC_CROUCHWALK_KNIFE, false },
	{ ACT_MP_SWIM, ACT_MERC_SWIM_KNIFE, false },

	{ ACT_MP_JUMP, ACT_MERC_JUMP_KNIFE, false },
	{ ACT_MP_JUMP_START, ACT_MERC_JUMP_START_KNIFE, false },
	{ ACT_MP_JUMP_FLOAT, ACT_MERC_JUMP_FLOAT_KNIFE, false },
	{ ACT_MP_JUMP_LAND, ACT_MERC_JUMP_LAND_KNIFE, false },

	{ ACT_MP_ATTACK_STAND_PRIMARYFIRE, ACT_MERC_ATTACK_STAND_KNIFE, false },
	{ ACT_MP_ATTACK_CROUCH_PRIMARYFIRE, ACT_MERC_ATTACK_CROUCH_KNIFE, false },
	{ ACT_MP_ATTACK_SWIM_PRIMARYFIRE, ACT_MERC_ATTACK_SWIM_KNIFE, false },
	{ ACT_MP_ATTACK_STAND_SECONDARYFIRE, ACT_MERC_ATTACK_STAND_KNIFE_BACKSTAB, false },
...
Activity CTFPlayerAnimState::ActivityOverride( Activity baseAct, bool *pRequired )
{
	...
	else
	{
		...
		else if ( pPlayer->GetPlayerClass()->GetClassIndex() == TF_CLASS_MERCENARY || 
			( pPlayer->m_Shared.GetDisguiseClass() == TF_CLASS_MERCENARY ) 
			)
		{
			CTFWeaponBase* pTFWeapon = pPlayer->GetActiveTFWeapon();

			if ( pPlayer->m_Shared.GetDisguiseClass() == TF_CLASS_MERCENARY )
			{
				pTFWeapon == ( pPlayer->m_Shared.GetDisguiseWeapon() );
			}
			...
			if (pTFWeapon != NULL)
			{
				...
				default:
					break;
				/* Never made animation tables for these
				case TF_WEAPON_CROWBAR:
				case TF_WEAPON_MEDKIT:
					//Wrong Table
					iActivityCount = ARRAYSIZE(m_acttableCrowbarMerc);
					pTable = m_acttableCrowbarMerc;
					break;
				*/
				/* Never made animation tables for these
				...
				*/
				...
				case TF_WEAPON_ASSAULT_RIFLE:
					iActivityCount = ARRAYSIZE(m_acttableRifleMerc);
					pTable = m_acttableRifleMerc;
					break;
